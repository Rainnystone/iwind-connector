/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=gateway/wrangler.jsonc gateway/src/worker-configuration.d.ts` (hash: cdd36ce8ade4a752377e2e3b49ef42d5)
