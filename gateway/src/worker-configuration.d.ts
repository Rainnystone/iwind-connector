/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=gateway/wrangler.jsonc gateway/src/worker-configuration.d.ts` (hash: 1635a3e2342ad5ec894dbda5b40be9e6)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WIND_API_KEY_01" | "WIND_API_KEY_02">> {}
}
